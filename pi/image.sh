...
sudo tar -xzvf /home/xubuntu/pi/ArchLinuxARM-rpi-2-latest.tar.gz -C /mnt/root
sudo tar -xzvf /home/xubuntu/pi/ArchLinuxARM-rpi-2-latest.tar.gz -C /mnt/root > /tmp/bsdtar12345
